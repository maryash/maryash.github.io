...
1. Create a new database by clicking the database icon with a plus sign in the top bar (**Control + O**). Fill it out with the following information:
...
3. Open the SQL Editor (**Alt + E**). Copy and paste the following code, then execute the query (**F9**):
