...
To learn more about logging in remotely, using Linux, following the lab rules, and dealing with possible issues, go to the [Linux accounts instuctions page](http://compsci.hunter.cuny.edu/~csdir/) and read the [CS Lab FAQ](comp_sci_faq.pdf).  
